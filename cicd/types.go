...
type (
	...
	Repo struct {
		...
		IsSpotguide     bool   `json:"spotguide"`
		SpotguideSource string `json:"spotguide_source"`
	...
	RepoPatch struct {
		...
		IsSpotguide     *bool   `json:"spotguide,omitempty"`
		SpotguideSource *string `json:"spotguide_source,omitempty"`
		Timeout         *int64  `json:"timeout,omitempty"`
		Visibility      *string `json:"visibility"`
